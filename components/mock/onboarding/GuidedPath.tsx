"use client";
/**
 * GuidedPath — "Build it with Oriant" (spec §8.2).
 *
 * One card at a time through the nine LEAN_CANVAS_BLOCKS: focused question,
 * guidance, example chips and the shared VoiceAnswer. After each confirmed
 * answer, "Improve wording with AI" shows Before vs Suggested side by side
 * with Accept / Edit / Keep original — the saved answer is NEVER replaced
 * automatically.
 */
import { useState } from "react";
import { AnimatePresence, motion, useReducedMotion, type Variants } from "framer-motion";
import { Check, ChevronLeft, Pencil, Wand2 } from "lucide-react";
        ...
        <AnimatePresence mode="wait" custom={dir} initial={false}>
          ...
          >
            <div style={{ display: "grid", gap: 8 }}>
              ...
              <p className="oa-sub">{block.guidance}</p>
            </div>
