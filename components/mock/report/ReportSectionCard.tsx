...
import type { ReportFactDef, ReportSectionDef, ReportSectionState } from "@/lib/mock/types";
  ...
  return (
    ...
    >
      ...
      <button
        ...
        aria-controls={`report-panel-${def.id}`}
