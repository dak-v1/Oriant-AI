 ...
 * and weekly outcome report (spec §19.1, §19.3, §22).
...
import type { CommandFixture, DailyDigestFixture, WeeklyReportFixture } from "../types";
import { AGENT, AGENT_NAME, DEMO_TODAY } from "./ids";

/** §19.3 daily digest for DEMO_TODAY (Friday 24 July 2026). */
export const DAILY_DIGEST: DailyDigestFixture = {
  ...
  reviews: [
    ...
    "Resolution plan for Mrs Wong (goodwill visit + $60 credit) — due today 12:00",
